...
ui <- navbarPage("USSC Federal Sentencing Dashboard",
                 ...
                 tabPanel("Custom Visualization",
                          ...
                          # JS enforcement (place right here in the same tabPanel)
                          tags$script(HTML("
...
# "))
                          ...
                          # ,
                          # tags$style(HTML("
                          #                   /* Make DataTable search box smaller and fit nicely */
                          #                   .dataTables_filter input {
                          ...
                          #                     background-color: #F5F5F5 !important; /* light background for dark theme */
                          #                     color: #000000 !important;    /* text color */
                          #                   }
                          #                   
                          #                   /* Optional: adjust filter label */
                          #                   .dataTables_filter label {
                          #                     color: #F5F5F5 !important;  /* make label readable on dark navbar */
                          #                     font-weight: normal !important;
                          #                   }
                          #                 "))
                          # 
                          ...
                          #                     display: flex !important;
                          #                     align-items: center !important;
                          #                     gap: 8px; /* space between 'Search:' and box */
                          #                     margin: 0;
                          #                   }
                          #                 
                          ...
                          #                   }
                          #                 
                          #                   /* Give wrapper relative positioning so absolute works */
                          #                   div.dataTables_wrapper {
                          #                     position: relative;
                          #                     padding-top: 2.5rem; /* prevent overlap with table */
                          #                   }
                          #                 "))
